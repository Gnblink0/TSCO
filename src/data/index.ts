...
export const airlines: Airline[] = [
  ...
  },
  {
    ...
    specialNotes: [
      "Carry-On and Personal bag must not exceed 22 lbs (10kg) combined for Basic Fare, 33 lbs (15 kg) for other fares. Personal size must fit under the seat in front of you.",
    ],
    updatedAt: undefined,
  },
  {
